...
parser.add_argument('--cam_num1', default=6, type=int, help='cam_num of source domain.market=6,duke=8')
parser.add_argument('--cam_num2', default=8, type=int, help='cam_num of target domain.market=6,duke=8')
